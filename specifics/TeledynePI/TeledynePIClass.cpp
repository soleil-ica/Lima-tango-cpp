...
void TeledynePIClass::attribute_factory(vector<Tango::Attr *> &att_list)
{
	...
	//	Attribute : adcQuality
	adcQualityAttrib	*adcquality = new adcQualityAttrib();
	Tango::UserDefaultAttrProp	adcquality_prop;
	adcquality_prop.set_description("Define the quality [LowNoise, HighCapacity, HighSpeed, ElectronMultiplied]");
	//	label	not set for adcquality
	//	unit	not set for adcquality
	//	standard_unit	not set for adcquality
	//adcquality_prop.set_display_unit("");
	//adcquality_prop.set_min_value(1);
	//adcquality_prop.set_max_value(4);
	//	format	not set for adcquality
	//	max_value	not set for adcquality
	//	min_value	not set for adcquality
	//	max_alarm	not set for adcquality
	//	min_alarm	not set for adcquality
	//	max_warning	not set for adcquality
	//	min_warning	not set for adcquality
	//	delta_t	not set for adcquality
	//	delta_val	not set for adcquality
	
	adcquality->set_default_properties(adcquality_prop);
	//	Not Polled
	adcquality->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	att_list.push_back(adcquality);


	//	Attribute : adcPixelBitDepth
	adcPixelBitDepthAttrib	*adcPixelBitDepth = new adcPixelBitDepthAttrib();
	Tango::UserDefaultAttrProp	adcPixelBitDepth_prop;
	adcquality_prop.set_description("Define the pixel bit depth");
	//	label	not set for adcPixelBitDepth
	//	unit	not set for adcPixelBitDepth
	//	standard_unit	not set for adcPixelBitDepth
	//adcPixelBitDepth_prop.set_display_unit("");
	//	format	not set for adcPixelBitDepth
	...
	adcPixelBitDepth->set_default_properties(adcPixelBitDepth_prop);
	//	Not Polled
	adcPixelBitDepth->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	att_list.push_back(adcPixelBitDepth);
