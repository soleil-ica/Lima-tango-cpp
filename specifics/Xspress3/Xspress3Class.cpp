...
//
// description : C++ source for the Xspress3Class. A singleton
...
//+----------------------------------------------------------------------------
/**
 *	Create Xspress3Class singleton and return it in a C function for Python usage
 */
//+----------------------------------------------------------------------------
extern "C" {
#ifdef WIN32
...
//
//-----------------------------------------------------------------------------
Xspress3Class::Xspress3Class(string &s):DeviceClass(s)
{
...
//+----------------------------------------------------------------------------
//	Method: Xspress3Class::attribute_factory(vector<Tango::Attr *> &att_list)
//-----------------------------------------------------------------------------
...
//
//-----------------------------------------------------------------------------
void Xspress3Class::get_class_property()
{
...
void Xspress3Class::set_default_property()
{
	...
	prop_name = "BaseIPAdress";
	prop_desc = "The base IP Adress of the xspress3";
	...
	prop_desc = "The base MAC address of the xspress3";
	...
	prop_name = "BasePort";
	prop_desc = "The base port of the xspress3";
	prop_def  = "30123";
	vect_data.clear();
	...
	prop_name = "UseDtc";
	prop_desc = "Enable or Disable dead time correction";
	prop_def  = "false";
	vect_data.clear();
	vect_data.push_back("false");
	if (prop_def.length()>0)
