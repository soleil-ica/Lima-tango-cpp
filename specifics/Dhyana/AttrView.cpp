...
//-----------------------------------------------------
//AttrView::init_common_attributes()
//-----------------------------------------------------
void AttrView::init_common_attributes()
{
    try
    {
        ...
        //Create sensorTemperature attribute
        {
            ...
            dai.wcb = yat4tango::DynamicAttributeWriteCallback::instanciate(*this, &AttrView::write_dynamic_attribute_callback);
        ...
        if(dynamic_cast<Dhyana*>(m_device)->get_camera()->is_trigOutput_available())
        {
            for (int i = 1; i < 4; i++)
            {
                ...
                //Instanciate the read callback (called when the dyn. attr. is read)    
                dai.rcb = yat4tango::DynamicAttributeReadCallback::instanciate(*this, &AttrView::read_dynamic_trigger_attribute_callback);
                //Instanciate the write callback
                dai.wcb = yat4tango::DynamicAttributeWriteCallback::instanciate(*this, &AttrView::write_dynamic_trigger_attribute_callback);
                //Do not clear attribute properties
                dai.cdb = false;
                //Add the dyn. attr. to the device
                m_dim.dynamic_attributes_manager().add_attribute(dai);
...
//-----------------------------------------------------
//AttrView::read_dynamic_attribute_callback()
//-----------------------------------------------------
void AttrView::read_dynamic_attribute_callback(yat4tango::DynamicAttributeReadCallbackData& cbd)
{
    try
    {
...
//-----------------------------------------------------
//AttrView::write_dynamic_attribute_callback()
//-----------------------------------------------------
void AttrView::write_dynamic_attribute_callback(yat4tango::DynamicAttributeWriteCallbackData& cbd)
{
    try
    {
        Tango::DevState state = static_cast<Dhyana*>(m_device)->get_state();
...
//-----------------------------------------------------
//AttrView::read_dynamic_trigger_attribute_callback()
//-----------------------------------------------------
void AttrView::read_dynamic_trigger_attribute_callback(yat4tango::DynamicAttributeReadCallbackData& cbd)
{
    try
    {
        Tango::DevState state = static_cast<Dhyana*>(m_device)->get_state();
...
//-----------------------------------------------------
//AttrView::write_dynamic_trigger_attribute_callback()
//-----------------------------------------------------
void AttrView::write_dynamic_trigger_attribute_callback(yat4tango::DynamicAttributeWriteCallbackData& cbd)
{
     try
    {
        Tango::DevState state = static_cast<Dhyana*>(m_device)->get_state();
...
//-----------------------------------------------------
//AttrView::read_dynamic_tec_attribute_callback()
//-----------------------------------------------------
void AttrView::read_dynamic_tec_attribute_callback(yat4tango::DynamicAttributeReadCallbackData& cbd)
{
    
}

//-----------------------------------------------------
//AttrView::write_dynamic_tec_attribute_callback()
//-----------------------------------------------------
void AttrView::write_dynamic_tec_attribute_callback(yat4tango::DynamicAttributeWriteCallbackData& cbd)
{
